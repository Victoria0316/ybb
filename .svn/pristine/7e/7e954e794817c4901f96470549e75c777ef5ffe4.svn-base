...
public class OrderDetailAdapter extends CommonAdapter<OrderMakeModel> implements SectionIndexer{
    ...
    public OrderDetailAdapter(Context context, List mDatas, int itemLayoutId) {
    ...
    public void convert(ViewHolder helper, final OrderMakeModel item, int position) {
        ...
        TextView pre_time_label = helper.getView(R.id.pre_time_label);
        pre_time.setVisibility(View.GONE);
        pre_time_label.setVisibility(View.GONE);
