 ...
 */
public class RecommendFoodModel {//推荐的
    private String attributeId;//餐次ID
    private String attributeName;//餐次名称
    private String canteenId;//所属食堂
    private String categoryId;//套餐类型（1营养餐2零点餐3医护套餐4医患套餐）
    private String comboName;//套餐名称
    private String comboPrice;//套餐价格
    private String commentCount;//评价人数
    private String commentStar;//综合评价星级
    private String createTime;//创建时间
    private String createUserId ;//创建人
    private String createUserName;//创建人名称
    private String customer_price;//现价
    private String endTime;//"结束时间
    private String id;//主键id"
    private String imgPath;//图片地址
    private String isColl;//是否被当前用户收藏，0：未收藏，1：已收藏
