...
//        PushManager.getInstance().initialize(this.getApplicationContext());
    ...
    public View createSuccessView(LayoutInflater inflater) {
        ...
        iv_clear_username = (ImageView) view.findViewById(R.id.iv_clear_username);
        iv_clear_username.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        iv_clear_password = (ImageView) view.findViewById(R.id.iv_clear_password);
        iv_clear_password.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                password.setText("");
            }
