...
//
//    public static final String CALL_BACK = "epp-mgr/blue/alipayRechargeCallBack/callback";
    public static final String CALL_BACK = "http://124.207.60.82:8080/ebbmgr/ali/alipayNotify";
//    public static final String CALL_BACK_ = "http://wangnan0306.eicp.net/ebbmgr/blue/alipayRechargeCallBack/callback";

    public static final String TRANSFER_IN_CALL_BACK = "http://124.207.60.82:8080/ebbmgr/blue/alipayRechargeCallBack/rechargeCallback";//转入回调
    public static final String TRANSFER_OUT_CALL_BACK = "http://124.207.60.82:8080/ebbmgr/blue/alipayRechargeCallBack/extractionCallback";//转出回调

    public static final String WX_APP_ID = "wx21c9bfb5a8d80ba8";
//    public static final String WX_APP_KEY = "wx21c9bfb5a8d80ba8";
  ...
  /**
   ...
   // 每页的基础数量
    ...
    public static  String  AD_CATEGORY_ID = "8aba20d04f0c23a6014f0c5642cc004e";


    public static final int MY_ALARM_WEEK_ACTIVITY_RESULT_OK =100;

    /**
     * 闹钟  Toast.makeText(this, "闹钟已取消", Toast.LENGTH_SHORT).show(); 开关
     */
