...
public final class YbbAlertDialog {
	...
	public YbbAlertDialog(Context context) {
	...
	public YbbAlertDialog addView(View v) {
	...
	public YbbAlertDialog setTitle(String text) {
		if (titleView == null) {
	...
	public YbbAlertDialog setMessage(String message) {
	...
	public YbbAlertDialog setNegativeButtonClickListener(String text,
	...
	public YbbAlertDialog setPositiveButtonClickListener(String text,
			OnClickListener listener) {
	...
	public YbbAlertDialog setPositiveButtonText(String text) {
		if (leftButton == null) {
	...
	public YbbAlertDialog setNegativeButtonText(String text) {
		if (rightButton == null) {
...
//		dividerParam.setMargins(dp10, 0, dp10, 0);
	...
	public YbbAlertDialog setMessageFromHtml(String htmlMessage) {
		if (messageTextView == null) {
			messageTextView = new TextView(context);
			messageTextView.setPadding(dp20, dp10, dp20, dp10);
			messageTextView.setTextColor(context.getResources().getColor(
