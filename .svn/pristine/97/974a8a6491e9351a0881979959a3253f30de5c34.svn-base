 ...
 */
public class OrderAgentCommitRequest extends YbbHttpJsonRequest<OrderCommitResponse> {

    private static final String APIPATH = "mobi/orderinfo/addAgentOrder";
    ...
    public OrderAgentCommitRequest(Response.Listener<OrderCommitResponse> listener,
                                   Response.ErrorListener errorListener) {
        super(Method.POST, APIPATH, listener, errorListener);
    }

    public OrderAgentCommitRequest(int method, String partUrl,
    ...
    public Map<String, String> GetParameters() {
        ...
        map.put("agentId", YbbApplication.getInstance().getAgentID());
        String orderType = "1";
