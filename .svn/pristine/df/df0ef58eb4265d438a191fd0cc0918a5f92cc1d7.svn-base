 ...
 */
public class YbbActivityManager
{
    public static YbbActivityManager instance;

    private Stack<Activity> activityStack;// activityջ

    private YbbActivityManager()
    {
    }

    public static YbbActivityManager getInstance()
    {
        if (instance == null)
        {
            instance = new YbbActivityManager();
        }
        return instance;
    }
