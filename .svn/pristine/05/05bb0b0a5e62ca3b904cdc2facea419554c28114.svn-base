...
public class CommoditiesRequest extends YbbHttpJsonRequest<CommodtiesResponse> {
    ...
    public CommoditiesRequest(Response.Listener<CommodtiesResponse> listener,
                              Response.ErrorListener errorListener) {
        super(Method.POST, APIPATH, listener, errorListener);
    }

    public CommoditiesRequest(int method, String partUrl,
                              Response.Listener<CommodtiesResponse> listener, Response.ErrorListener errorListener) {
