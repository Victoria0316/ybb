...
public class OrderCartCommitRequest extends YbbHttpJsonRequest<OrderCommitResponse> {
    ...
    private String orderType;//	string	是	订单类型（值为“病患”或“医护”，登录时获取的是什么直接传过来就行）
    private String userId;
    private String reserveTime;

    public OrderCartCommitRequest(Response.Listener<OrderCommitResponse> listener,
                                  Response.ErrorListener errorListener) {
        super(Method.POST, APIPATH, listener, errorListener);
    }

    public OrderCartCommitRequest(int method, String partUrl,
