 ...
 */
public class PSOrderList implements Serializable {
    ...
    private  PSOrderBean         productComboGroupDTO;//
    ...
    public PSOrderBean getProductComboGroupDTO() {
        return productComboGroupDTO;
    }

    public void setProductComboGroupDTO(PSOrderBean productComboGroupDTO) {
