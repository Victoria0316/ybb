package com.bluemobi.ybb.ps.service;
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if (Environment.MEDIA_MOUNTED.equals(Environment
			...
			updateDir = new File(Environment.getExternalStorageDirectory(),
					"ebb");
			updateFile = new File(updateDir.getPath(), "ebbPs" + ".apk");
		}
		...
		// 设置下载过程中，点击通知栏，回到主界面
		updateIntent = new Intent(this, DiliverymanMainActivity.class);
		updatePendingIntent = PendingIntent.getActivity(this, 0, updateIntent,
				0);
		// 设置通知栏显示内容
		updateNotification.icon = R.mipmap.ic_launcher;
		updateNotification.tickerText = "开始下载";
		updateNotification.setLatestEventInfo(this, getApplicationContext().getString(
						R.string.app_name), "0%",
				updatePendingIntent);
		// 发出通知
			...
			case DOWNLOAD_COMPLETE:
				...
				updateNotification.setLatestEventInfo(UpdateService.this,
						getApplicationContext().getString(
								R.string.app_name), "下载完成,点击安装。", updatePendingIntent);
				updateNotificationManager.notify(0, updateNotification);
