 ...
 */
public class MineOrderBackPageAdapter extends BaseAdapter {
    private final static String tag = "MineOrderBackPageAdapter";
    ...
    public MineOrderBackPageAdapter(Context c, List<Orderinfoinfo> data) {
        this.mListData = data;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View includeView = view.findViewById(R.id.il_order_btn);
        ...
        for (int i =0 ; i<datasize; i++){
            ...
            isColl.setTag(R.id.isColl,
                    mListData.get(position).getOrderItemDTOList().get(i).getProductComboGroupDTO().getIsColl());
        ...
        CollectionRequest request = new CollectionRequest(new Response.Listener<CollectionResponse>() {
            ...
            public void onResponse(CollectionResponse response) {
                ...
                if (response != null && response.getStatus() == 0) {// success
                    ...
                    MineOrderBackPageAdapter.this.notifyDataSetChanged();
