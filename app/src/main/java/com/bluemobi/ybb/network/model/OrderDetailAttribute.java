...
/**
 * Created by wangzhijun on 2015/8/28.
 */
public class OrderDetailAttribute {
    private String changeTime;// "2015-08-27 17:08:11",
    private String cityCode;// "8aba20b74f16fc10014f1739a3160001",
    private String cityName;// "脚23",
    private String createTime;// "2015-08-27 17:08:11",
    ...
    private String distributionTime;// "2015-08-27 17:08:11",
    private String distributionType;// 0,
    private String districtCode;// "null",
    private String districtName;// "null",
    private String id;// "ff8080814f6d2c1c014f6e6a1b640611",
    private String logisticsId;// "null",
    private String logisticsName;// "null",
    private String logisticsProductIdStr;// "12,ff8080814f6d2cef014f6e59c8a9001c",
    private String logisticsProductNumStr;// "1,1",
    private String optTime;// "2015-08-27T17:08:11+08:00",
    private String orderId;// "ff8080814f6d2c1c014f6e6a1b21060c",
    private String provinceCode;// "1",
    private String provinceName;// " 医院1",
    private String receiverCellphone;// "13654990997",
    private String receiverName;// "wangzhijun",
    private String remark;// "null",
    private String reserveTime;// "null",
    private String shopsId;// "-1",
    private String status;// 0,
    private String userId;// "ff8080814f1553be014f158371ff000f"
    private ArrayList<OrderDetailChild> productInfoDTOList;
    ...
    public ArrayList<OrderDetailChild> getProductInfoDTOList() {
        return productInfoDTOList;
    }

    public void setProductInfoDTOList(ArrayList<OrderDetailChild> productInfoDTOList) {
