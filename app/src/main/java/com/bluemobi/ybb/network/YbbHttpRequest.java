...
public abstract class YbbHttpRequest<T extends YbbHttpResponse> extends
        Request<T> implements YbbHttpBase<T>
{
     ...
     * @param errorListener
     */
    public YbbHttpRequest(int method, String partUrl, Listener<T> listener,
    ...
    public YbbHttpRequest(int method,String serverUrl, String partUrl, Listener<T> listener,
                           ErrorListener errorListener)
    {
