...
public class WxPayUtils {
    ...
    public static final String WX_PARTNER_ID = "1230702301";//1262575801@1262575801

    private static final String API_KEY = "TRtAMDus7PpBUapYhvhcnfWXHWX7N0g3"; // wx21c9bfb5a8d80ba8 对应的支付密钥

    public static void pay(Activity activity, WxOrderModel obj) {
        mActivity = activity;
...
//        api.registerApp(WX_APP_ID);
    ...
    private static void doPay(WxOrderModel obj) {
...
//        req.partnerId = "1230702301@1230702301";
        req.prepayId = obj.getPrepayid();
