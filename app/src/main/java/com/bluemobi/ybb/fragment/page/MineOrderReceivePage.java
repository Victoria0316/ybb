...
import com.bluemobi.ybb.adapter.MineOrderObligationPageAdapter;
import com.bluemobi.ybb.adapter.MineOrderReceivePageAdapter;
 ...
 *         P14-1我的订单-餐品 待收货
 */
public class MineOrderReceivePage extends BasePage {
    private final static String tag ="MineOrderReceivePage";
    ...
    public MineOrderReceivePage(Context context,BaseFragment baseFragment) {
    ...
    public View initView(LayoutInflater inflater) {
        View homeView = inflater.inflate(R.layout.page_order_receive, null);
