...
{
    private final static String tag="MineOrderBackPage";
    private Context mContext;
    private OrderAdapter adapter;

    private List<OrderItem> dataList = new ArrayList<OrderItem>();

//    private MineOrderBackPageAdapter mineOrderBackPageAdapter;
    ...
    public View initView(LayoutInflater inflater) {
        ...
        View homeView = inflater.inflate(R.layout.page_order_back,null);
