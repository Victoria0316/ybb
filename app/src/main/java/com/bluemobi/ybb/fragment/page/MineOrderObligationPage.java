 ...
 *         P14-1我的订单-餐品 待付款
 */
public class MineOrderObligationPage extends BasePage {
    private final static String tag = "MineOrderObligationPage";
    ...
    public MineOrderObligationPage(Context context, BaseFragment baseFragment) {
    ...
    public View initView(LayoutInflater inflater) {
        ...
        View homeView = inflater.inflate(R.layout.page_order_obligation, null);
